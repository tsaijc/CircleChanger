...
class CircleChanger(object):
    ...
    def __init__(self, x, y, radius, fill_color, colors):
        ...
        self.starting_color = fill_color
        self.index = 0
    ...
    def get_distance_from(self, point):
        ...
        point.get_distance_from(self.circle.center)
    ...
    def swell_or_shrink_once(self, amount_to_swell_or_shrink):
        ...
        # r-index goes into r-colors goes into fill colors
    ...
    def swell_or_shrink_repeatedly(self,
        ...
        for k in range(times_to_swell_or_shrink):
            ...
            self.draw()
            self.swell_or_shrink_once( - amount_to_swell_or_shrink) # add and subtract & put in argument
            self.draw()
    ...
    def swallow(self, other_circle_changer):
        ...
        newcirclechanger = CircleChanger(other_circle_changer.circle.center.halfway_to(self.circle.center).x,
    ...
    def change_to_original_color(self):
        ...
        self.circle.fill_color = self.starting_color
